...
function SelectTrigger({
	...
	return (
		<SelectPrimitive.Trigger
			...
			data-size={size}
			className={cn(
				'flex w-fit cursor-pointer items-center justify-between gap-2 whitespace-nowrap rounded-lg border border-border bg-white px-3 py-2 text-[14px] text-foreground shadow-none outline-none transition-colors',
				'data-[placeholder]:text-muted-foreground',
				'focus-visible:border-primary focus-visible:ring-[3px] focus-visible:ring-ring/30',
				'disabled:cursor-not-allowed disabled:opacity-50',
				'data-[size=default]:h-10 data-[size=default]:text-[14px] data-[size=sm]:h-8 data-[size=sm]:text-sm',
