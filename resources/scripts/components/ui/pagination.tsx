	...
	<button
		...
		className={cn(
			...
			active
				...
				: 'border-border text-foreground/60 hover:border-primary/40 hover:bg-primary/[0.06] hover:text-primary bg-white',
			...
			<div className="flex items-center gap-3">
				...
				<div className="flex items-center gap-2">
					<PageBtn
						...
						aria-label={__('Previous page', 'allfeedback')}
					>
					...
					{slots.map((slot, i) =>
						slot === 'ellipsis' ? (
							<span
								key={`ellipsis-${i}`}
								className="text-muted-foreground/50 flex size-10 items-center justify-center text-[14px] select-none"
							>
