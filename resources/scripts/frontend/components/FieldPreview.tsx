...
const StarRatingField = ( { field, value, onChange }: { field: SurveyField; value: string; onChange: ( v: string ) => void } ) => {
...
const ScaleField = ( { field, value, onChange }: { field: SurveyField; value: string; onChange: ( v: string ) => void } ) => {
