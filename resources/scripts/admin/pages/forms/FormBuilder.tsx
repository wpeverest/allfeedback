	...
	return (
		<div className="allfb-builder bg-background fixed inset-0 z-[99999] flex flex-col">
			...
			<div className="flex flex-1 overflow-hidden">
				...
				<div
					className="group border-border hover:bg-muted/40 relative flex w-3 shrink-0 cursor-col-resize items-center justify-center border-x bg-white transition-colors"
					onMouseDown={startResize}
				>
					<div className="flex items-center gap-[3px] opacity-20 transition-opacity group-hover:opacity-60">
						<div className="bg-foreground h-6 w-[2px] rounded-full" />
						<div className="bg-foreground h-6 w-[2px] rounded-full" />
					</div>
				</div>
