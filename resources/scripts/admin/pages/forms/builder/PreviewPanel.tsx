	...
	return (
		<div className="flex h-full flex-col bg-white">
			...
			{viewMode === 'page' ? (
				...
				<div className="bg-background/50 flex flex-1 items-center justify-center overflow-hidden p-6">
			...
			<div
				className={cn(
					'border-border flex shrink-0 items-center border-t px-4 py-3 transition-opacity',
