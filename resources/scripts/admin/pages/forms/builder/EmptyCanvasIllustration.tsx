...
const EmptyCanvasIllustration = () => (
	...
	>
		...
		<rect x="81"  y="120" width="4"  height="8"  rx="1.2" fill="var(--muted-foreground)" fillOpacity="0.22" />
		<rect x="94"  y="118" width="16" height="12" rx="3"   fill="var(--muted-foreground)" fillOpacity="0.10" />
		<path d="M98 120 Q98 128 101.5 128 Q105 128 105 120"
			stroke="var(--muted-foreground)" strokeOpacity="0.25" strokeWidth="1.3" fill="none" />
		<rect x="114" y="118" width="16" height="12" rx="3"   fill="var(--muted-foreground)" fillOpacity="0.10" />
		<line x1="116" y1="124" x2="128" y2="124"
			stroke="var(--muted-foreground)" strokeOpacity="0.28" strokeWidth="1.4" />
		<line x1="136" y1="119" x2="136" y2="129"
			stroke="var(--border)" strokeOpacity="0.5" strokeWidth="1" />
		<rect x="140" y="118" width="22" height="12" rx="3" fill="var(--muted-foreground)" fillOpacity="0.10" />
		...
		<rect x="62" y="151" width="2" height="14" rx="1"
			fill="var(--primary)" fillOpacity="0.55" />
		...
		<circle cx="180" cy="259" r="7" fill="var(--muted-foreground)" fillOpacity="0.08" />
		<line x1="177" y1="259" x2="183" y2="259"
			stroke="var(--muted-foreground)" strokeOpacity="0.28" strokeWidth="1.6" strokeLinecap="round" />
		<line x1="180" y1="256" x2="180" y2="262"
			stroke="var(--muted-foreground)" strokeOpacity="0.28" strokeWidth="1.6" strokeLinecap="round" />
