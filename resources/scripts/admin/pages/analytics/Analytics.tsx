...
const Analytics = () => {
	...
	const [selectedFormId, setSelectedFormIdState] = useState<number | null>(
		initialFormId !== undefined && Number.isFinite(initialFormId)
			? initialFormId
			: null,
	);
			...
			<div style={{ padding: '20px 32px' }}>
				...
				>
					<EmptyState
						...
						description={__(
							'Analytics will appear here once your forms start receiving responses.',
							'allfeedback',
						)}
					/>
				</div>
		...
		<div style={{ padding: '0 32px 32px' }}>
			...
			<div
				style={{
					...
					...(isRefetching && { opacity: 0.5, pointerEvents: 'none' }),
				}}
			>
				<div
					style={{
