...
- **PHP-DI compiled container** lives in `wp-content/cache/allfeedback/`. Changing `config/services.php` without clearing it crashes on boot:
  ```bash
  rm -rf "/c/Users/Themegrill/Local Sites/test/app/public/wp-content/cache/allfeedback"
  ```
